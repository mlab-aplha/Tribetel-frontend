            ...
            <div className={styles.footerContent}>
                <div className={styles.brandSection}>
                    ...
                    <p className={styles.brandDescription}>
                        Experience luxury and comfort with Tribtel. Your perfect getaway starts here with exceptional service and unforgettable memories.
                    </p>
                ...
                <div className={styles.linksSection}>
                    ...
                    <div className={styles.linkList}>
                        ...
                        <Link to="/hotels" className={styles.linkItem}>Hotels</Link>
                        <Link to="/vacations" className={styles.linkItem}>Vacations</Link>
                        <Link to="/about" className={styles.linkItem}>About Us</Link>
                        <Link to="/search" className={styles.linkItem}>Search</Link>
                    </div>
                </div>
                ...
                <div className={styles.linksSection}>
                    ...
                    <div className={styles.linkList}>
                        <span className={styles.linkItem}>Luxury Rooms</span>
                        <span className={styles.linkItem}>Spa & Wellness</span>
                        <span className={styles.linkItem}>Fine Dining</span>
                        <span className={styles.linkItem}>Event Spaces</span>
                        <span className={styles.linkItem}>Airport Transfers</span>
                    </div>
                </div>
                ...
                <div className={styles.linksSection}>
                    ...
                    <div className={styles.linkList}>
                        ...
                        <span className={styles.linkItem}>Booking Help</span>
                        <span className={styles.linkItem}>Privacy Policy</span>
                        <span className={styles.linkItem}>Terms of Service</span>
                    </div>
                </div>
            </div> {/* Added missing closing div for footerContent */}

            {/* Bottom Bar */}
            <div className={styles.footerBottom}>
                <div className={styles.bottomContent}>
                    <div className={styles.copyright}>
                        © 2025 Tribtel. All rights reserved.
                    </div>
